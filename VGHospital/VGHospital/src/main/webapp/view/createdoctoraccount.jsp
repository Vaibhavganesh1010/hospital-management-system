...
body{
    ...
    background: url(/view/img/bg.jpg);
...
<html>
  ...
  <body>
    <!-- Body of Form starts -->
  	<div class="container">
        <div class="heading">Create Doctor Account</div>
      <form  action="createdoctoraccount" method="post" autocomplete="on">
        <!--First name-->
    		<div class="box">
      ...
      <div >
     <button class="backlogin" ><a href="drlogin">BacktoLogin</a></button>
    </div>
  </div>
  <!--Body of Form ends--->
  </body>
