...
<html>
  ...
  <body>
    <!-- Body of Form starts -->
  	<div class="container">
        <div class="heading">Create Staff Account</div>
      <form  action="createstaffaccount" method="post" autocomplete="on">
        <!--First name-->
    		<div class="box">
      ...
      <div >
     <button class="backlogin" ><a href="stafflogin">BacktoLogin</a></button>
    </div>
  </div>
  <!--Body of Form ends--->
  </body>
