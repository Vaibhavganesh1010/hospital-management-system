...
<div class="animated bounceInDown">
  <div class="container">
    ...
    <form action="doctorlogin" name="form1" class="box" method="post" >
      <h4>Doctor<span>Dashboard</span></h4>
      <h5>Sign in to your account.</h5>
       ...
       <!-- <a href="#" class="forgetpass">Forget Password?</a> -->
        ...
        <a href="doctorcreateaccount" class="dnthave">Don’t have an account? Sign up</a>
  </div> 
       <!--<div class="footer">
